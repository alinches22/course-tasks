...
import { CreateBattleForm } from '@/components/dashboard/create-battle-form';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils/cn';

type TabType = 'open' | 'my' | 'finished';
...
export default function DashboardPage() {
  ...
  const tabs: { id: TabType; label: string; filter: any }[] = [
    { id: 'open', label: 'Open Battles', filter: { status: 'WAITING' } },
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary">Manage your battles and track your progress</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Create battle */}
          <div>
            <CreateBattleForm onSuccess={() => setRefreshKey((k) => k + 1)} />
          </div>
        </div>
      </motion.div>
    </div>
